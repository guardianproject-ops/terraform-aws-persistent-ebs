...
Like this project? Please give it a ★ on [GitLab](https://gitlab.com/guardianproject-ops/terraform-aws-persistent-ebs)
...
File an [issue](https://gitlab.com/guardianproject-ops/terraform-aws-persistent-ebs/issues), send us an [email][email] or join us in the Matrix 'verse at [#guardianproject:matrix.org][matrix] or IRC at `#guardianproject` on Freenode.

## Contributing

### Bug Reports & Feature Requests

Please use the [issue tracker](https://gitlab.com/guardianproject-ops/terraform-aws-persistent-ebs/issues) to report any bugs or file feature requests.
